...
class Setup:
    ...
    def defaultValues(self):
        ...
        """
        return {
            name: described_value.value
            for name, described_value in self._default_values.items()
        }
    ...
    def runFullGrid(
        ...
        experiments = [
            collections.OrderedDict(
                [
                    (dim, DescribedValue(combi[i]))
                    for i, dim in enumerate(parameter_ranges.keys())
                ]
            )
    ...
    def runExperiment(
        self, param_set: Dict[str, Any], default_values: Optional[Dict[str, Any]] = None
    ):
        """
    ...
    def runExperiments(
        self,
        experiments: Union[List[Dict[str, Any]], Dict[str, Any]],
        default_values=None,
    ):
        """
